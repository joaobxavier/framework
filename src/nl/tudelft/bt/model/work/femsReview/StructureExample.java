package nl.tudelft.bt.model.work.femsReview;
 ...
 */
public class StructureExample extends ModelHandler {
	...
	protected static String outputDirectory = "C:/results/femsReview/structure/roughLowNutrient";

	// protected static String outputDirectory =
	// "C:/results/femsReview/structure/smoothStartThick";
	...
	//protected static float substrateBulkConcentration = 1e-4f; // [g/L] //high

	protected static float substrateBulkConcentration = 5e-5f; // [g/L] //low
	...
	// Yield coefficients
	private static float YXS = 0.5f; // [gX/gS] // smooth

	// private static float YXS = 0.05f; // [gX/gS] // fingers

	// Processes
	// Growth (biomass production)
	protected static float uMax = 0.72f; // [1/h]
	...
	protected static float systemSize = 200f; // [um]
	...
	private static BiomassSpecies speciesX;
	...
	// double y = Model.model().getRandom();
	// double nbin = Math.floor(y*n);
	// y = (Math.asin(Math.pow(2*(y*n - nbin)-1, 3))/Math.PI +0.5+nbin)/n;
	// placeBiomass(speciesX, Model.model().getRandom()*systemSize*0.05f
	// , (float)(y*systemSize), 0);
	// }
	// }
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new StructureExample();
		...
		try {
			// gorw once to make sure cells are colored when firs writing
			Model.model().overrideTimeStep(0.001f);
			app.writeState();
			app.performFullIteration();
			app.writeState();
			Model.model().setTimeStepBackToManual();
