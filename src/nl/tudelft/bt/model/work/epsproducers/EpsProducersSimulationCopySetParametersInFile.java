...
/**
 * A copy of the EpsProducers program with parameters to be set directly on file
 * 
 * @author Joao Xavier (jxavier@cgr.harvard.edu)
 */
public class EpsProducersSimulationCopySetParametersInFile extends ModelHandler {
	...
	public static void run() {
		...
		ApplicationComponent app = new EpsProducersSimulationCopySetParametersInFile();
	...
	public static void main(String[] args) {
		...
		int total = 100;
		initialParticleNumberWT = Math.round(total * 0.10f);
		initialParticleNumberEpsMinus = total - initialParticleNumberWT;
		//
		timeForWritingToDisk = 2f;
		//
		run();
	}
}