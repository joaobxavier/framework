...
/**
 * Simulates growth of a two species in a 2D colony spreading on agar plate
 * where one has a higher growth rate
 * 
 * @author Joao Xavier (jxavier@cgr.harvard.edu)
 */
public class SelectionOnGrowthRate extends GranuleModelHandler {
	...
	protected static int initialParticleNumberGreen = 40;
	protected static int initialParticleNumberRed = 10;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		// aerobic growth Red
		Reaction aerobicGrowthRed = new Reaction("growthRed", activeRed,
				uMax * 1.5f, 1);
	...
	protected void inoculate() {
		int[] nCells = { initialParticleNumberGreen, initialParticleNumberRed };
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new SelectionOnGrowthRate();
