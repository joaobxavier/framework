 ...
 */
public class DriftIn2DColonyInluxFromAboveUnboundedMovement extends
		GranuleModelHandler {
	...
	protected static String outputDirectory = "C:/results/colony/neutralEvolution/";
	...
	//private static float fMaintenance = 0.5f; // fraction of uMax that goes to
	...
	// The SBR sycle
	protected static float sBulkConcentration = 3e-3f; // [gO2/L] DO 20
	...
	protected static float initialColonyRadius = 10; // [um]
	...
	protected static int initialParticleNumber = 15;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies speciesGreen = new BiomassWithNeutralColors("speciesGreen",
		...
		// maintenance Green
		Reaction growthAndMaintenanceGreen = new Reaction("maintenanceGreen", activeGreen,
				uMax, 1);
		growthAndMaintenanceGreen.addFactor(mSWithMaintenace);
		// aerobic growth Red
		Reaction aerobicGrowthRed = new Reaction("growthRed", activeRed, uMax,
				1);
		aerobicGrowthRed.addFactor(mS);
		// maintenance red
		Reaction maintenanceRed = new Reaction("maintenanceRed", activeRed,
				uMax, 1);
		maintenanceRed.addFactor(mSWithMaintenace);
		...
		rsActiveGreen.addReaction(growthAndMaintenanceGreen, 1);
		activeGreen.setProcesses(rsActiveGreen);
		// active Red
		NetReaction rsActiveRed = new NetReaction(1);
		rsActiveRed.addReaction(maintenanceRed, 1);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new DriftIn2DColonyInluxFromAboveUnboundedMovement();
