 ...
 */
public class DriftIn2DColonyInluxFromAbove extends GranuleModelHandler {
	...
	protected static int initialParticleNumber = 40;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		rsSubstrate.addReaction(flux, 1e4f);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new DriftIn2DColonyInluxFromAbove();
