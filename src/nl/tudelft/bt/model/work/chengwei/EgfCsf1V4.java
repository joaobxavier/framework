 ...
 */
public class EgfCsf1V4 extends TumorModelHandler {
	...
	protected static String outputDirectory = "/Users/xlabguest/results/v4/test30";
	...
	protected static float glucoseBulkConcentration = 0.72e-17f; // [g/L]
	...
	protected static float qEgf = 0.057f;   //[nmol/gcell/h]
	protected static float deltaqEgf = 100f;	//[nmol/gcell/h]
	protected static float n = 2f;
	protected static float csf1T = 50e-15f;         //[nM]
	//protected static float decayRate = .75f; 

	protected static float qCsf1 = 0.057f;
	protected static float deltaqCsf1 = 100f;
	protected static float m = 1.7f;
	protected static float egfT = 50e-15f;
	
	//protected static float alphaegf = 4.9656f; //[nmol/gcell/h]
	protected static float betaegf = 60.656f/deltaqCsf1;
	
	//protected static float alphaCsf1 = 4.9656f;
	protected static float betaCsf1 = 60.656f/deltaqEgf;
	...
	// Cost of CSF-1
	private static float c = 1e-15f; // [gX/gS]
...
//						0.3f, 0.0f, 0.0f), Color.red);
		...
		Reaction upregEgf = new Reaction("upregulated EGF secretion",
				macrophage, deltaqEgf, 2);
		upregEgf.addFactor(new Hill(csf1, csf1T, 1));
		...
		Reaction basalCsf1_p = new Reaction("basal CSF-1 secretion producer",
				cancer_producer, qCsf1, 1);
		basalCsf1_p.addFactor(mS);
		Reaction upregCsf1_p = new Reaction("upregulated CSF secretion",
				cancer_producer, deltaqCsf1, 2);
		upregCsf1_p.addFactor(new Hill(egf, egfT, 1));
		...
		// Netreactions for signals
		NetReaction netReactionEgf = new NetReaction(4);
		...
		NetReaction netReactionCsf1 = new NetReaction(5);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new EgfCsf1V4();
