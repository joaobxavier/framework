 ...
 */
public class EgfCsf1V3a extends TumorModelHandler {
	...
	protected static String outputDirectory = "/Users/xlabguest/results/3D/test4";
	...
	protected static float glucoseBulkConcentration = 1e-2f; // [g/L]
	...
	protected static float decayRate = 1e-5f;
	

	protected static float qEgf = 14.8572e-9f;
	protected static float deltaqEgf = 14.8572e-5f;
	protected static float n = 2f;
	protected static float csf1T = 50f;

	protected static float qCsf1 = 14.8572e-9f;
	protected static float deltaqCsf1 = 14.8572e-5f;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		Reaction growth_m = new Reaction("growth_c", macrophage, uMax, 1);
		growth_m.addFactor(mS);
		...
		//macrophages
		NetReaction netReactionMacrophage = new NetReaction(1);
		netReactionMacrophage.addReaction(growth_m, 1);
		...
		netReactionEgf.addReaction(decayEgf, -decayRate);
		...
		netReactionCsf1.addReaction(decayCsf1f, -decayRate);
		...
		netReactionGlucose.addReaction(growth_m, -(1 / YXS));
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new EgfCsf1V3a();
