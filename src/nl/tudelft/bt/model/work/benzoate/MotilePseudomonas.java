...
/**
 * Two species system with Acinetobacter sp. and Pseudomonas putida -- constant
 * bulk concentrations of benzyl alcohol, benzoate and oxygen -- motile
 * Pseudomonas
 * 
 * @author Joao Xavier (jxavier@cgr.harvard.edu)
 */
public class MotilePseudomonas extends ModelHandler {
	// output directory name
	private static String outputDirectory = "C:/results/motile/";
	...
	// motiliy
	private static float motilityDiffusivity = 20f; // [um2/h]
	...
	//private static float systemSize = 50f; // [micron]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies pseudomonas = new MotileBiomassSpecies("Pseudomonas",
	...
	public static void main(String[] args) {
		...
		//
		ApplicationComponent app = new MotilePseudomonas();
		...
		try {
			...
			Model.model().setCompulsoryTimeStep(0.5f);
