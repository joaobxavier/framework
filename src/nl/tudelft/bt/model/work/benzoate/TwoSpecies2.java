 ...
 */
public class TwoSpecies2 extends ModelHandler {
	// output directory name
	private static String outputDirectory = "C:/results/twospecies2/";
	...
	// Benzyl alcohol
	private static float benzylOHBulkConcentration = 0.1f; // [gCOD_S/l]

	private static float benzylOHDiffusivity = 4e6f; // [um2/h]

	private static float KBenzylOH = 4e-3f; // [gO/l]

	// Benzoate
	private static float benzoateBulkConcentration = 0; // [gO/l]

	private static float benzoateDiffusivity = 8e6f; // [um2/h]

	private static float KBenzoate = 3.5e-4f; // [gO/l]
	...
	private static float KOxygen = 3.5e-4f; // [gO/l]
	...
	private static float YXBenzylOH = 0.495f; // [gCOD_X/gCOS_S]

	private static float YXBenzoate = 0.495f; // [gCOD_X/gCOS_S]

	private static float YBenzoateProduction = 0.1f; // [gCOD_X/gCOS_S]

	// Processes
	// Benzyl alcohol uptake by Acinetobacter
	private static float qBenzylOHMax = 0.952f; // [gCOD_S/gCOD_X/h]

	// Benzoate uptake by P. putida
	private static float qBenzoate = 0.952f; // [gCOD_S/gCOD_X/h]

	// Computation parameters
	private static float systemSize = 1000f; // [micron]
	...
	//reactor properties
	private static float residenceTime = 10f; // [h]
	private static float reactorVolume = 50f;    // [L]
	private static float carrierArea = 1e-3f;   // [?]

	// inoculation
	private static int initialCellNumber = 10;
	...
	public static void main(String[] args) {
		...
		//
		ApplicationComponent app = new TwoSpecies2();
