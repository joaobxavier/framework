 ...
 */
public class TwoSpecies1 extends ModelHandler {
	// output directory name
	private static String outputDirectory = "C:/results/twospecies1/";
	...
	private static float relativeMaximumRadius = 7f / systemSize;
	...
	public static void main(String[] args) {
		...
		//
		ApplicationComponent app = new TwoSpecies1();
