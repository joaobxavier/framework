 ...
 */
public class Tumor3DModel extends GranuleModelHandler {
	...
	protected static String outputDirectory = "/Users/xavierj/results/tumor2d/test";
	...
	protected static float relativeMaximumRadius = 10f / systemSize;
	...
	protected static float relativeBoundaryLayer = 500f / systemSize;
	...
	// NOTE: Use this line to turn off gradients
	...
	// Death rates
	protected static float kdT = uMaxT * 4f;// lactate effect strength on tumor
											// cells (relative to growth)
	protected static float kdM = kdT * 2f;// lactate effect strength on
											// macrophages (relative to cancer
											// sensitivity)
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies speciesM = new LiveDeadBiomassSpecies("speciesM", spM,
				fractionalVolumeCompositionM, lactate, 0.02f);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new Tumor3DModel();
		...
		try {
			...
			Model.model().overrideTimeStep(10f);
			app.startIterating();
