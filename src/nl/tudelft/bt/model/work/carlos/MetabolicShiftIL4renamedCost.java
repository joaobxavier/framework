 ...
 */
public class MetabolicShiftIL4renamedCost extends TumorModelHandler {
...
///////////// Solute parameters	// Substrate (S) - the only solute species used here
	...
	private static float IL4Diffusivity = 4.8e4f ; // [um^2/h] ref. 4e-7cm2/s ("Diffusion of interleukin-2 from cells overlaid with cytocompatible enzyme-crosslinked gelatin hydrogels.")
...
//	private static float oKS = 3.5e-4f; // [g/L]
	...
	protected static SoluteSpecies IL4;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		// IL4
			 IL4 = new SoluteSpecies("IL4", IL4Diffusivity);
		...
		// active mass
		NetReaction rsXactiveCC = new NetReaction(5);
		rsXactiveCC.addReaction(aeroGrowthCC, 1);
		rsXactiveCC.addReaction(anaGrowthCC, 1);
		rsXactiveCC.addReaction(BiomassDecayCC, -1);
		rsXactiveCC.addReaction(csf1secretion, -1);
		rsXactiveCC.addReaction(IL4secretion, -1);
		activeCC.setProcesses(rsXactiveCC);
		
		NetReaction rsXactiveTAM = new NetReaction(4);
		...
		rsXactiveTAM.addReaction(egfsecretion, -1);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new MetabolicShiftIL4renamedCost();
