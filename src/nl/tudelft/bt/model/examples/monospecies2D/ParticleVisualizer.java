...
/**
 * Creates a panel for visualizing progress of the simulation. It draws the
 * particles in the biofilm and a contour plot showing the concentration of
 * oxygen 
 *
...
public class ParticleVisualizer extends ChartPanel {
	...
	/**
	 * Update the data concerning particles presently in the simulation
	 */
	...
	/**
	 * @return formatted text string of the present simulation time
	 */
