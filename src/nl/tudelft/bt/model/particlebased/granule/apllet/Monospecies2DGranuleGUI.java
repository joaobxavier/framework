...
public class Monospecies2DGranuleGUI extends JPanel implements ActionListener {
	...
	public Monospecies2DGranuleGUI() {
		...
		//the qMax Slider
		_qMaxRangeSlider = new SliderCreator("q<sub>Max</sub><sup>O</sup>",
				"h<sup>-1</sup>", 0.1f, 2.0f, 0.8f, new DecimalFormat("0.###"));
		...
		/*_detachmentRangeSlider = new LogSliderCreator("Detachment constant",
				"", 0, 1e-1f, 1.68e-3f, new DecimalFormat("0.##E0"), 4f);*/
		_detachmentRangeSlider = new LogSliderCreator("Detachment constant",
				"", 0, 1e-1f, 1e-2f, new DecimalFormat("0.##E0"), 4f);
