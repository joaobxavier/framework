/**
 * @(#)QuickTimeOutputStream.java  1.3.2  2010-10-01
 *
 ...
 *
 *
 * @deprecated Use {@link QuickTimeWriter} instead of this class.
 *
 * @author Werner Randelshofer
 * @version 1.3.2 2010-10-01 Changes "hdlr" "componentName" from cstring to
 * pstring.
 ...
 * <br>1.2.1 2010-05-11 Fixes constructor comments.
 * <br>1.2 2009-08-29 AddsRAW encoder.
 * <br>1.1 2008-08-11 Streamlines source code and API with AVIOutputStream.
 * <br>1.0.1 2008-06-18 WideDataAtom wrote incorrect header for
...
public class QuickTimeOutputStream {
     ...
     * @exception IllegalArgumentException if format is null.
     */
     ...
     * @exception IllegalArgumentException if format is null.
     */
    public QuickTimeOutputStream(ImageOutputStream out, VideoFormat format) throws IOException {
        if (format == null) {
            throw new IllegalArgumentException("format must not be null");
        }
     ...
     * track.
     * @throws IOException if writing the data sample failed.
     */
    ...
    private void writeEpilog() throws IOException {
        ...
        d.writeUInt(0); // componentManufacturer
        // Reserved. Set to 0.
        ...
        d.writePString(""); // componentName (empty string)
