...
resDir = 'D:\joao\results';
% res(1).baseDir = [resDir '/TubeTest'];
% res(2).baseDir = [resDir '/TubeTest2'];
% res(2).baseDir = [resDir '/TubeTest_5e-4'];
res(1).baseDir = [resDir '/TubeNoDetachment'];
